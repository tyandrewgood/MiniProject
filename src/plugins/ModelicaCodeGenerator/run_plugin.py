"""
This script is called by the plugin-wrapper, ModelicaCodeGenerator.js, which passes down the
...
from ModelicaCodeGenerator import ModelicaCodeGenerator
...
plugin = ModelicaCodeGenerator(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
